            ...
            <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link href="/favorites" className="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition-colors">
                  ...
                  <span className="text-sm font-medium">{t('navbar.favorites')}</span>
                </Link>
                ...
                <Link href="/cart" className="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition-colors">
                  ...
                  <span className="text-sm font-medium">{t('navbar.cart')}</span>
                </Link>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <div className="space-y-8">
                <div className="space-y-4">
                  {isAuthenticated ? (
                    <>
                      <div className="flex items-center text-gray-700 py-3">
                        <svg className="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                        <div>
                          <span className="text-lg font-medium">{t('navbar.welcome')}, {user.name}</span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="flex items-center text-gray-700 py-3 hover:text-red-600 transition-colors w-full text-left"
                      >
                        <svg className="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                        </svg>
                        <span className="text-lg font-medium">{t('navbar.logout')}</span>
                      </button>
                    </>
                  ) : (
                    <Link href="/login" className="flex items-center text-gray-700 py-3 hover:text-blue-600 transition-colors">
                      <svg className="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                      </svg>
                      <span className="text-lg font-medium">{t('navbar.login')}</span>
                    </Link>
                  )}
      ...
      <div className={`md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 transition-transform duration-300 z-40 ${isMobileMenuOpen ? 'translate-x-full' : 'translate-x-0'}`}>
        <div className="flex items-center justify-around py-2">
          ...
          <Link href="/" className="flex flex-col items-center py-2 px-3 rounded-lg transition-colors">
            ...
            <span className="text-xs text-gray-600">{t('navbar.home')}</span>
          </Link>
          ...
          <Link href="/category" className="flex flex-col items-center py-2 px-3 rounded-lg transition-colors">
            ...
            <span className="text-xs text-gray-600">{t('navbar.categories')}</span>
          </Link>
          ...
          <Link href="/favorites" className="flex flex-col items-center py-2 px-3 rounded-lg transition-colors">
            ...
            <span className="text-xs text-gray-600">{t('navbar.myFavorites')}</span>
          </Link>
          ...
          <Link href="/cart" className="flex flex-col items-center py-2 px-3 rounded-lg transition-colors">
            ...
            <span className="text-xs text-gray-600">{t('navbar.myCart')}</span>
          </Link>
        </div>
      </div>
    </div>
